...
def get_metadata(constants):
    ...
    tissue_mask_directory = base_path / "tissue_masks"
    graph_directory = preprocess_directory / "graphs"
...
def show_segmentation_masks(output, annotation=None, **kwargs):
    ...
    cbar = fig.colorbar(im, ticks=[0, 1, 2], cax=cbar_ax)
